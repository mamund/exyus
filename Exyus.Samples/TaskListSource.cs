...
namespace Exyus.Samples
{
    ...
    class TaskListSource : PlainTextViewer
    {
        public TaskListSource()
        {
            ...
            this.Files.Add("get_response_json.xsl", "/xcs/documents/tasklist/get_response_json.xsl");
            this.Files.Add("get_response_atom.xsl", "/xcs/documents/tasklist/get_response_atom.xsl");
            this.Files.Add("post_request_form.xsl", "/xcs/documents/tasklist/post_request_form.xsl");
            this.Files.Add("post_request_json.xsl", "/xcs/documents/tasklist/post_request_json.xsl");
            this.Files.Add("post_request_atom.xsl", "/xcs/documents/tasklist/post_request_atom.xsl");
            ...
            this.Files.Add("post_atom.xsd", "/xcs/documents/tasklist/post_atom.xsd");
            this.Files.Add("put_request_json.xsl", "/xcs/documents/tasklist/put_request_json.xsl");
            this.Files.Add("put_request_atom.xsl", "/xcs/documents/tasklist/put_request_atom.xsl");
            this.Files.Add("put_xml.xsd", "/xcs/documents/tasklist/put_xml.xsd");
            this.Files.Add("put_atom.xsd", "/xcs/documents/tasklist/put_atom.xsd");
