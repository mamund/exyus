...
namespace Exyus.Web
{
    ...
    public class XmlFileResource : ExyusResource
    {
        ...
        public XmlFileResource()
        {
            ...
            s_ext = util.GetConfigItem(Constants.cfg_fileExtension, Constants.msc_sys_file_ext);
        ...
        public override void Post()
        {
            ...
            try
            {
                ...
                this.Location = util.GetConfigItem(Constants.cfg_rootfolder)+util.ReplaceArgs(this.PostLocationUri,arg_list) + id;
